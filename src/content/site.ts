...
/**
 * Плашка-манифест сразу под первым экраном. Текст разбит надвое: вторая
 * фраза набирается градиентом, поэтому живёт отдельной строкой.
 */
export const statement = {
  lead: "Нейросети — это не будущее.",
  accent: "Это ваш шаг вперёд уже сейчас.",
} as const;
